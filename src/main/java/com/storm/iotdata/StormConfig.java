...
public class StormConfig implements Serializable{
    ...
    public StormConfig(){
        ...
        this.stormBrokerURL = (String) obj.getOrDefault("storm.brokerURL", this.stormBrokerURL);
        this.stormTopicList = (List<String>) obj.getOrDefault("storm.topicList", this.stormTopicList);
        this.stormWindowList = (List<Integer>) obj.getOrDefault("storm.windowList", this.stormWindowList);
